            ...
            public static List<TournamentModel> ConvertToTournamentModels(this List<string> lines)
            {
                ...
                foreach (string line in lines)
                {
                    ...
                    //tm.EnteredTeams.Add(teams.Where(x => x.Id == int.Parse(Id)).First());
                        var team = teams.FirstOrDefault(x => x.Id == int.Parse(Id));
                        if (team != null)
                        {
                    ...
                    if (cols[4].Length > 0)
                    {
                        ...
                        var prize = prizes.FirstOrDefault(x => x.Id == int.Parse(Id));
                        if (prize != null)
                        {
                            tm.Prizes.Add(prize);
                        }
                ...
                foreach (string round in rounds)
                    {
                        ...
                        Console.WriteLine($"Looking for Matchup ID: {matchupModelTextId}");
                        var matchup = matchups.FirstOrDefault(x => x.Id == int.Parse(matchupModelTextId));
                        if (matchup != null)
                        {
                            ms.Add(matchup);
                        }
